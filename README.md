[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/saengate/airflow-worker)](https://github.com/saengate/airflow-worker/releases/latest)
[![GitHub](https://img.shields.io/github/license/saengate/airflow-worker)](LICENSE)
[![GitHub contributors](https://img.shields.io/github/contributors/saengate/airflow-worker)](https://github.com/saengate/airflow-worker/graphs/contributors)
[![Build Status](https://travis-ci.org/saengate/airflow-worker.svg?branch=master)](https://travis-ci.org/saengate/airflow-worker)

## Descripción workers de apache airflow
Contiene las instrucciones para instalar nodos de airflow,
depende del proyecto, [saengate:django](https://travis-ci.org/saengate/django)
